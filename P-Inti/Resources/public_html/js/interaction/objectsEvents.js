...
//        widgetapplyDeselectedStyle(lastSelectedWidget);
//        lastSelectedWidget = null;
//    }
//    if (lastSelectedOutput != null) {
//        outputapplyDeselectedStyle(lastSelectedOutput);
...
//                                    if (LOG) console.log(b);
                            ...
                            widget.applyDeselectedStyle = function (unSelectConnectorsToo) {
                                if (LOG) {
                                    console.log("widget.applyDeselectedStyle");
                                }
                                ...
                                if (unSelectConnectorsToo) {
                                    this.connectors.forEach(function (connector) {
                                        connector.applyDeselectedStyle(false, false);
                                    });
                                }
                            };
