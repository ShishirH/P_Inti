...
//        if (LOG) console.log(minX.untransformedY);
        ...
        ySlider.applyDeselectedStyle = function () {
        ...
        ySlider.on('outConnectionRemoved', function (options) {
            ...
            fabric.util.removeFromArray(ySlider.outConnections, removedConnection);
...
//            if (LOG) console.log("Mouse DOWN over the ySlider of a function");
            ...
            if (theEvent) {
                ...
                ySlider.outConnections.push(newConnector);
                    ...
                    if (targetObject) {
                        ...
                        if (targetObject !== ySlider) {
                            ...
                            if (targetObject.isImage) {
                                ...
                                var connector = ySlider.outConnections.pop();
                                connector.contract();
                                ...
                                if (targetObject.isOutput) {
                                    ...
                                    var connector = getLastElementOfArray(ySlider.outConnections);
                        ...
                        var connector = ySlider.outConnections.pop();
                        connector.contract();
                        fabric.util.removeFromArray(ySlider.outConnections, connector);

                        // The mouse up event is done over a blank section of the canvas
//                        var lastAddedConnector = getLastElementOfArray(ySlider.outConnections);
//                        var options = {
//                            left: coordX,
//                            top: coordY,
//                            fill: ySlider.fill,
...
//        if (LOG) console.log(xSlider.untransformedY);
        ...
        xSlider.on('inValueUpdated', function (options) {
            ...
            xSlider.outConnections.forEach(function (outConnector) {
        ...
        xSlider.on('newInConnection', function (options) {
            ...
            if (xSlider.inConnections.length > 0) {
                var connector = xSlider.inConnections.pop();
                connector.contract();
            }
            ...
            xSlider.inConnections.push(newInConnection);
                    ...
                    if (targetObject) {
                        ...
                        if (targetObject !== xSlider) {
                            ...
                            if (targetObject.isImage) {
                                ...
                                // removing the last connector added when the widget was down clicked 
                                var connector = xSlider.outConnections.pop();
                                connector.contract();
                                ...
                                if (targetObject.isOutput) {
                                    ...
                                    if (LOG) console.log("%c HERE !!!!", "background: red; color: white;");
                                    // if the mouse up event happens over an existing output                                
                                    var connector = getLastElementOfArray(xSlider.outConnections);
                                    connector.setDestination(targetObject, true);
                        ...
                        if (connector) {
                            ...
                            connector.contract();
                            fabric.util.removeFromArray(xSlider.outConnections, connector);
...
//      });
        ...
        xSlider.on('pressed', function (option) {
            ...
            xSlider.outConnections.push(newConnector);
            ...
            if (theEvent) {
                ...
                if (xSlider.lockMovementX && xSlider.lockMovementY) {
                    ...
                    if (theEvent) {
                        ...
                        var lastAddedConnector = getLastElementOfArray(xSlider.outConnections);
                    ...
                    xSlider.inConnections.forEach(function (connector) {
                        connector.contract();
                    });
        ...
        if (shouldAnimate) {
            ...
            fabric.util.animate({
                ...
                onChange: function (value) {
                    ...
                    /*xSlider.inConnections.forEach(function (inConnector) {
...
//                    ctx.fillText("(" + xCoordinate + "," + yCoordinate + ")", x2 + 10, y2 + 6);
    ...
    updateOutputValue: function (shouldAnimate) {
        ...
        theContinuousFunction.ySlider.outConnections.forEach(function (outConnector) {
