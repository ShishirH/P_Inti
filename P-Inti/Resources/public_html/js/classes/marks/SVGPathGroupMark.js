SVGPathGroupMark = fabric.util.createClass(fabric.Group, {
    ...
    initialize: function (elements, options) {
        ...
        var obj = new fabric.Group(elements);
        canvas.add(obj);
        options || (options = {});
        ...
        var angleValue = null;
        if (options.values) {
            widthValue = options.values.width || createNumberValue({unscaledValue: (this.the_width || this.width), inPrexi: null, outPrefix: null, units: 'pixels'});
            heightValue = options.values.height || createNumberValue({unscaledValue: this.the_height || this.height, inPrefix: null, outPrefix: null, units: 'pixels'});
            angleValue = options.values.angle || createNumberValue({unscaledValue: -this.angle, inPrefix: null, outPrefix: null, units: 'degrees'});
        } else {
            widthValue = createNumberValue({unscaledValue: this.the_width || this.width, inPrefix: null, outPrefix: null, units: 'pixels'});
            heightValue = createNumberValue({unscaledValue: this.the_height || this.height, inPrefix: null, outPrefix: null, units: 'pixels'});
            angleValue = createNumberValue({unscaledValue: -this.angle, inPrefix: null, outPrefix: null, units: 'degrees'});
        }
