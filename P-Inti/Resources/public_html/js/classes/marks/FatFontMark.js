...
//      this.specificProperties.push({attribute: "fontFamily", readable: true, writable: true, types: ['string'], updatesTo: [], dataTypeProposition: 'isStringValue', value: createNumericValue(this.fontFamily)});
