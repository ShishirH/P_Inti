    ...
    updateOutputVisibilityStatus: function () {
        ...
        if (!theCollectionGetter.theCollection.isEmpty() && theCollectionGetter.theCollection.iconName) {
            ...
            if (!theCollectionGetter.outputPoint.opacity) {
                ...
                blink(theCollectionGetter.outputPoint, 0.3);
    ...
    addNumber: function () {
        ...
        theNumber.on({
            'mousedown': function (options) {
                ...
                theNumber.outConnections.push(newConnector);
            ...
            'mouseup': function (options) {
                ...
                if (theNumber.connecting) {
                    ...
                    var connector = getLastElementOfArray(theNumber.outConnections);
                    ...
                    if (targetObject) {
                        ...
                        if (targetObject !== this) {
                            ...
                            if (targetObject.isMark) {
                                ...
                                connector = theNumber.outConnections.pop();
                                if (connector) {
                                    connector.contract();
                                }
                            }
                        ...
                        var lastAddedConnector = getLastElementOfArray(theNumber.outConnections);
        ...
        theCollectionGetter.on({
            ...
            'valueChanged': function (options) {
                ...
                if (index < 1) {
                    ...
                    changedVisualValue.outConnections.forEach(function (outConnector) {
...
function addCollectionGetter(x, y) {
    ...
    blink(aCollectionGetter.atSymbol, 0.3);
    blink(aCollectionGetter.theCollection, 0.3);
    blink(aCollectionGetter.theNumber, 0.3);
    blink(aCollectionGetter, 0.2);
