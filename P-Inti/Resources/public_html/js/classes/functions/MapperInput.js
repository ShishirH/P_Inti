var MapperInput = fabric.util.createClass(fabric.Path, {
    ...
    setValue: function (value, shouldAnimate) {
        ...
        theMapperInput.outConnections.forEach(function (outConnector) {
    ...
    associateEvents: function () {
        ...
        theMapperInput.on({
            'pressed': function (options) {
                ...
                theMapperInput.outConnections.push(newConnector);
            ...
            'mouseup': function (options) {
                ...
                if (theMapperInput.connecting) {
                    ...
                    var connector = getLastElementOfArray(theMapperInput.outConnections);
...
//                                        connector.destination.bringToFront();
                                ...
                                connector = theMapperInput.outConnections.pop();
                                if (connector) {
                                    connector.contract();
                                }
                            }
            ...
            'moving': function (options) {
                ...
                if (theMapper) {
                    ...
                    if (theMapperInput.connecting) {
                        ...
                        var lastAddedConnector = getLastElementOfArray(theMapperInput.outConnections);
                        ...
                        theMapperInput.inConnections.forEach(function (inConnector) {
...
//            },
            'newInConnection': function (options) {
                ...
                if (theMapperInput.inConnections.length > 0) {
                    var connector = theMapperInput.inConnections.pop();
                    connector.contract();
                }
                ...
                theMapperInput.inConnections.push(newInConnection);
                blink(theMapperInput, 0.3);
