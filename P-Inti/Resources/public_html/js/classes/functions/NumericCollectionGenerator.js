...
//            console.log("%c" + "\t visualProperty.xmlID = " + visualProperty.xmlID, "background: rgb(243,128,146); color: black;");
    ...
    generateValues: function () {
        ...
        theGenerator.outConnections.forEach(function (outConnector) {
            ...
            'moving': function (options) {
                ...
                if (theCollectionGenerator.lockMovementX && theCollectionGenerator.lockMovementY && !theCollectionGenerator.mapper && !theCollectionGenerator.isEmpty()) {
                    ...
                    if (theEvent) {
                        ...
                        var lastAddedConnector = getLastElementOfArray(theCollectionGenerator.outConnections);
            ...
            'mouseup': function (options) {
                ...
                if (theGenerator.lockMovementX && theGenerator.lockMovementY) {
                    ...
                    if (theEvent) {
                        ...
                        var connector = getLastElementOfArray(theGenerator.outConnections);
...
//                                            connector.destination.bringToFront();
                                    ...
                                    connector = theGenerator.outConnections.pop();
                                    if (connector) {
                                        connector.contract();
                                    }
                                }
                            ...
                            var lastAddedConnector = getLastElementOfArray(theGenerator.outConnections);
