var VerticalCollection = fabric.util.createClass(fabric.Rect, {
    ...
    addTypeIcon: function (iconName, blinkingFactor, doNotBlinkCollection) {
        ...
        if (theMapper) {
            ...
            blink(theCollection, blinkingFactor);
            ...
            if (!theMapper.isCompressed) {
                ...
                theCollection.expand(theMapper.valueScale, intendedNumberOfElements);
...
//        drawRectAt(topCenter, 'red');
    ...
    compress: function (valuesFinalScale) {
...
//                visualValue.bringToFront();
    ...
    growHeight: function (targetHeight) {
    ...
    expand: function (valuesFinalScale, intendedNumberOfElements, valueUnscaledHeight) {
...
//                visualValue.bringToFront();
                ...
                visualValue.outConnections.push(newConnector);
            ...
            'mouseup': function (options) {
                ...
                if (theVisualValue.connecting) {
                    ...
                    var connector = getLastElementOfArray(theVisualValue.outConnections);
...
//                                    connector.destination.bringToFront();
                                ...
                                if (theVisualValue.isDurationValue) {
...
//                                        connector.destination.bringToFront();
                                ...
                                connector = theVisualValue.outConnections.pop();
                                if (connector) {
                                    connector.contract();
                                }
                            }
            ...
            'moving': function (options) {
                ...
                if (theVisualValue.connecting) {
                    ...
                    var lastAddedConnector = getLastElementOfArray(theVisualValue.outConnections);
    ...
    associateEvents: function () {
        ...
        this.on({
            'doubleTap': function (options) {
                ...
                if (!theCollection.mapper) {
                    if (theCollection.isCompressed) {
                        theCollection.expand();
                    } else {
                        theCollection.compress();
                    }
                }
            },
            'pressed': function (options) {
                ...
                if (!theCollection.mapper && !theCollection.isEmpty()) {
                    ...
                    blink(theCollection.typeIcon, 0.45);
                    blink(theCollection, 0.45);
                    ...
                    theCollection.outConnections.push(newConnector);
                    canvas.add(newConnector);
            ...
            'moving': function (options) {
                ...
                if (theCollection.lockMovementX && theCollection.lockMovementY && !theCollection.mapper && !theCollection.isEmpty()) {
                    ...
                    if (theEvent) {
                        var canvasCoords = getCanvasCoordinates(theEvent);
                        var lastAddedConnector = getLastElementOfArray(theCollection.outConnections);
                        lastAddedConnector.set({x2: canvasCoords.x, y2: canvasCoords.y});
                    }
            ...
            'mouseup': function (options) {
                ...
                if (theCollection.lockMovementX && theCollection.lockMovementY) {
                    ...
                    if (theEvent) {
                        ...
                        var connector = getLastElementOfArray(theCollection.outConnections);
...
//                                            connector.destination.bringToFront();
                                    ...
                                    connector = theCollection.outConnections.pop();
                                    if (connector) {
                                        connector.contract();
                                    }
                                }
            ...
            'inConnectionRemoved': function (options) {
                ...
                if (LOG)
                    console.log("Before: ");
                if (LOG)
                    console.log(this.inConnections);
            ...
            'outConnectionRemoved': function (options) {
                ...
                if (LOG)
                    console.log("Before: ");
                if (LOG)
                    console.log(this.outConnections);
            ...
            'newInConnection': function (options) {
                ...
                if (theCollection.inConnections.length > 0) {
                    var connector = theCollection.inConnections.pop();
                    connector.contract();
                }

                theCollection.outConnections.forEach(function (outConnector) {
                    outConnector.setValue(incommingValue, false, shouldAnimate);
                });

                theCollection.inConnections.push(newInConnection);
...
//                });
//
//                theCollection.inConnections.push(inConnection);
...
//        popSound.play();
        ...
        if (theCollection.iconName) {
            ...
            if (theCollection.isCompressed) {
                ...
                blink(theCollection.typeIcon, 0.30);
                blink(theCollection, 0.30);
