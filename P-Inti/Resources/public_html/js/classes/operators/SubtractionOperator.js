var SubtractionOperator = fabric.util.createClass(Operator, {
    ...
    subtractFrom: function (a, b) {
        ...
        if ($.isArray(a)) {
            ...
            if ($.isArray(b)) {
                ...
                // subtracting DATES
                if (a.isDateAndTimeValue && b.isDateAndTimeValue) {
    ...
    computeOutputValue: function (shouldAnimate) {
        ...
        if (theOperator.inConnections.length) {
            ...
            if (theOperator.inConnections.length === 1) {
                ...
                result = theOperator.inConnections[0].value;

            } else {
                
                var firstValue = theOperator.inConnections[0].value;
                var secondValue = theOperator.inConnections[1].value;
                ...
                for (var i = 1; i < theOperator.inConnections.length; i++) {
                    ...
                    result = subtractValues(result, theOperator.inConnections[i].value, outPrefix);
                }*/
