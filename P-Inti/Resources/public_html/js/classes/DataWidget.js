        ...
        this.on('moving', function (option) {
            ...
            this.visualVariables.forEach(function (visualVariable) {
                if (theDataWidget.isCompressed) {
                    visualVariable.outConnections.forEach(function (connector) {
...
// Set another completion function for the request above
    ...
    addVariable: function (canvasCoords, variableName) {
        ...
        namedCollection.outConnections = new Array();
        ...
        namedCollection.on({
                ...
                if (targetObject) {
                    ...
                    if (targetObject !== namedCollection && !targetObject.isDataWidget) {                        
                        ...
                        if (targetObject.isVerticalCollection) {
                            ...
                            var connector = getLastElementOfArray(namedCollection.outConnections);
                            ...
                            var connector = namedCollection.outConnections.pop();
                            if (connector) {
                                connector.contract();
                            }
                        }
                        ...
                        console.log("namedCollection.outConnections.length:");
                        console.log(namedCollection.outConnections.length);
                    ...
                    var lastAddedConnector = getLastElementOfArray(namedCollection.outConnections);
            ...
            'mousedown': function (option) {
                ...
                namedCollection.outConnections.push(newConnector);
...
//
//        for (var i = 0, len = theDataWidget.inConnections.length; i < len; i++) {
//
//            var x = topLeft.x + indent + (i + 0.5) * separation;
//
...
//        if (LOG) console.log("Animating child");
        ...
        fabric.util.animate({
            ...
            onChange: function (value) {
                child[prop] = value;
                child.outConnections.forEach(function (connector) {
