...
//        console.log(options);
        ...
        this.specificProperties.push({attribute: "shape", readable: true, writable: false, types: ['string', 'object'], updatesTo: [], dataTypeProposition: 'isShapeValue'});
        this.specificProperties.push({attribute: "fill", readable: true, writable: false, types: ['string'], updatesTo: [], dataTypeProposition: 'isColorValue'});
            ...
            if (theExtractor.moving) {
                ...
                if (theEvent) {
                    ...
                    if (targetObject) {
                        ...
                        sourceFillVisualProperty.outConnections.push(fillConnector);
                        ...
                        sourceAreaVisualProperty.outConnections.push(areaConnector);
...
//                            fill: lastAddedConnector.arrowColor,
                        ...
                        var circularMark = addMarkToCanvas(markOptions);
                        ...
                        targetFillVisualProperty.inConnections.push(fillConnector);
                        ...
                        targetAreaVisualProperty.inConnections.push(areaConnector);
