...
//            drawRectAt(new fabric.Point(x,y), generateRandomColor());
        ...
        for (var i = 0; i < theExtractor.visualProperties.length; i++) {
            ...
            theExtractor.animateVisualProperty(i, 'opacity', 1, duration, easing, false, false);
            theExtractor.animateVisualProperty(i, 'scaleX', 1, duration, easing, false, false);
            theExtractor.animateVisualProperty(i, 'scaleY', 1, duration, easing, false, false);
            theExtractor.animateVisualProperty(i, 'left', positions[i].x, duration, easing, false, false);
            theExtractor.animateVisualProperty(i, 'top', positions[i].y, duration, easing, false, false);
            theExtractor.animateVisualProperty(i, 'top', positions[i].y, duration, easing, false, isTheLastElement, isTheLastElement);
...
//        theBackground.animate('top', theExtractor.top, {
        ...
        for (var i = 0; i < theExtractor.visualProperties.length; i++) {
            var isTheLastElement = i == theExtractor.visualProperties.length - 1;
            theExtractor.animateVisualProperty(i, 'opacity', 0, duration, easing, true, false);
            theExtractor.animateVisualProperty(i, 'scaleX', 0, duration, easing, true, false);
            theExtractor.animateVisualProperty(i, 'scaleY', 0, duration, easing, true, false);
            theExtractor.animateVisualProperty(i, 'left', objectCenter.x, duration, easing, true, false);
            theExtractor.animateVisualProperty(i, 'top', objectCenter.y, duration, easing, true, isTheLastElement, false);
        }
