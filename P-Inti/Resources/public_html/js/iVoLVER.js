...
//                    // console.log(theInput);
        ...
        addcodeMultiverseSection: function () {
            ...
            let divName = $('<div class="row" style="width:auto">' +
                '<div class="col-12"><button id="addCodeMultiverseButton" type="button" class="btn rightPaneAddCodeMultiverse" style="width:80%" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus rightPaneMultiversePlusSvg" viewBox="0 0 16 16">' + "\n" +
                '<path style="stroke-width: 2px; stroke: black" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>' + "\n" +
                '</svg></button></div>' + "\n" +
                '</div>');
            // let nameElement = $('');
