...
namespace HelloWorldApp
{
    ...
    class Geeks
    {
        ...
        { Logger.logLineInfo(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~12~        {");
            ...
            string foo = "bar"; Logger.logLineInfo(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~18~            string foo = "bar";");Logger.logInitialization(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~foo~18",foo);
            // To prevent the screen from  Logger.logLineInfo(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~19~            // To prevent the screen from ");
            // running and closing quickly  Logger.logLineInfo(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~20~            // running and closing quickly ");
            Console.ReadKey(); Logger.logLineInfo(@"C:\Users\hamid\Downloads\ConsoleApp1\ConsoleApp1\Program.cs~21~            Console.ReadKey();");
        }
    }
}